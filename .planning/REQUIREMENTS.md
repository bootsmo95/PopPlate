...
- [ ] **USAG-01**: System records each 3D model generation with user ID and timestamp
- [ ] **USAG-02**: User can see their generation count for the current rolling 31-day window
- [ ] **USAG-03**: System enforces tier-based generation limits (blocks generation when limit reached)
