...
<template>
	<!-- Mobile top bar -->
	<div
		class="platform-mobile-top sticky top-0 z-40 hidden items-center justify-between border-b border-line px-5 py-3"
		style="
	...
	>
		<NuxtLink
			to="/"
			class="inline-flex items-center gap-3 font-display italic font-medium text-[19px] tracking-tight text-ink"
		>
			<LogoMark :size="24" />
			<span>popplate</span>
		</NuxtLink>
	...
	>
		...
		<nav class="flex flex-col gap-0.5 mb-3.5">
			...
			<NuxtLink to="/platform/settings#restaurants" class="nav-item" @click="close">
