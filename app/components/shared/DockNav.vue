...
<template>
	...
	<header class="dock-mobile">
		...
		<div class="flex items-center gap-2">
			<NuxtLink :to="effectiveCtaHref" class="dock-mobile-cta">
				{{ effectiveCtaLabel }}
			</NuxtLink>
	...
	<nav class="dock-desktop" aria-label="Hovedmenu">
		<NuxtLink to="/" class="dock-logo-pill" aria-label="popplate">
			<LogoMark :size="22" />
			<span>popplate</span>
		</NuxtLink>
