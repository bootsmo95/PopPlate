  ...
  <div class="min-h-screen flex items-center justify-center bg-gray-100 px-4">
    <div class="w-full max-w-sm bg-white rounded-xl shadow-md p-8">
      <div class="mb-8 text-center">
        <h1 class="text-2xl font-bold text-gray-900">PopPlate Platform</h1>
      ...
      <div class="space-y-5">
        ...
        <p class="text-center text-sm text-gray-500">
          Need an account?
          <NuxtLink to="/platform/signup" class="text-slate-700 font-medium hover:underline">Create one via Authentik</NuxtLink>
        </p>
      </div>
