...
<template>
  <div class="auth-shell" data-screen-label="Signup">
    <!-- Form side -->
    <div class="auth-form-side">
      ...
      <div class="auth-card">
        <div class="auth-eyebrow">Opret konto</div>
        <h1 class="auth-title">
          Kom i gang med <span class="italic text-clay-deep">menu i 3D</span>.
        </h1>
        <p class="auth-sub">14 dages gratis prøve. Ingen binding.</p>
    ...
    <div class="auth-visual">
      ...
      <div class="auth-credit">
        <div class="auth-credit-tag">popplate · Ny restaurant</div>
        <div class="auth-credit-quote">
          Jeres første ret i <span class="italic text-clay-soft">3D</span> — på under fem minutter.
        </div>
      </div>
    </div>
  </div>
